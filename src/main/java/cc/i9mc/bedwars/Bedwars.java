package cc.i9mc.bedwars;

import cc.i9mc.gameutils.BukkitGameUtils;
import cc.i9mc.k8sgameack.K8SGameACK;
import cc.i9mc.k8sgameack.utils.IPUtil;
import cc.i9mc.bedwars.commands.AdminCommand;
import cc.i9mc.bedwars.commands.StartCommand;
import cc.i9mc.bedwars.database.map.MapData;
import cc.i9mc.bedwars.database.map.MapDataSQL;
import cc.i9mc.bedwars.game.Game;
import cc.i9mc.bedwars.listeners.*;
import cc.i9mc.bedwars.scoreboards.GameBoard;
import cc.i9mc.bedwars.scoreboards.LobbyBoard;
import cc.i9mc.bedwars.specials.SpecialItem;
...
public final class Bedwars extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (getConfig().getBoolean("isUP")) {
            ...
            K8SGameACK.getInstance().getServerData().setGameType("BedWars");
            ...
            BukkitGameUtils.getInstance().getPubSubListener().addChannel("MINIGame.BW." + IPUtil.getLocalIp());
    ...
    public int getLevel(int level) {
        int playerLevel = 0;
        for (Map.Entry<Integer, Integer> entry : Bedwars.playerLevel.entrySet()) {
