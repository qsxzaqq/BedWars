package cc.i9mc.bedwars.specials.w;
...
public class TNTSheepRegister {
    ...
    public TNTSheep spawnCreature(final cc.i9mc.bedwars.specials.TNTSheep specialItem, final Location location, final Player owner, Player target, final DyeColor color) {
        ...
        }.runTaskLater(Bedwars.getInstance(), 5L);
