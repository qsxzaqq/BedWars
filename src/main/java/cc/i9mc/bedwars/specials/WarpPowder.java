...
public class WarpPowder extends SpecialItem {
    ...
    private Game game = Bedwars.getInstance().getGame();
    ...
    public void runTask() {
        ...
        this.teleportingTask = new BukkitRunnable() {
            ...
            public String particle = "fireworksSpark";
            ...
            public void run() {
                try {
                    ...
                    GameTeam team = GamePlayer.get(WarpPowder.this.player.getUniqueId()).getGameTeam();
        ...
        }.runTaskTimer(Bedwars.getInstance(), 0L,
