        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    }.runTaskLater(Bedwars.getInstance(), (5 * 20) + 13);
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                new BukkitRunnable() {
                    ...
                    @Override
                    public void run() {
                        TNTPrimed primed = (TNTPrimed) that.getGame().getMapData().getBases().get(0).toLocation().getWorld().spawnEntity(oldLoc, EntityType.PRIMED_TNT);
                ...
                }.runTaskLater(Bedwars.getInstance(), 3L);
            }
