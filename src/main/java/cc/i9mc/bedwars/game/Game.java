...
import cc.i9mc.bedwars.events.BedwarsGameStartEvent;
import cc.i9mc.bedwars.game.event.EventManager;
...
public class Game {
    ...
    public Game(Bedwars main, Location waitingLocation) {
        this.main = main;
    ...
    public void addPlayer(GamePlayer gamePlayer) {
        ...
        TitleUtil.sendTitle(player, 0, 30, 5, "§e§l经典起床战争", mapData.getAuthor().equals("unknown") ? "§b游戏地址: PLAY.MCYC.WIN" : "§b建筑师: " + mapData.getAuthor() + " 游戏地址: PLAY.MCYC.WIN");
