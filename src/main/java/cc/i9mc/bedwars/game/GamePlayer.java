...
import cc.i9mc.bedwars.types.ArmorType;
...
public class GamePlayer {
    ...
    public void toSpectator(String title, String subTitle) {
        ...
        player.teleport(Bedwars.getInstance().getGame().getGameTeams().get(0).getSpawn());
    ...
    public static class PlayerCompass {
        ...
        public void sendClosestPlayer() {
            GamePlayer closestPlayer = Bedwars.getInstance().getGame().findTargetPlayer(gamePlayer);
